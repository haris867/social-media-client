...
describe('Creating post', () => {
  ...
  it('creates post when provided with required inputs', () => {
    ...
    cy.get('input[name="media"]').type(
      'https://images.unsplash.com/photo-1532798369041-b33eb576ef16?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80'
    );
    cy.wait(400);
